    ...
    >
      <SwiperSlide>
        <div className="w-[100%] h-screen relative">
          <Image src={img1} fill className="object-cover" alt="img" />
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className="w-[100%] h-screen relative">
          <Image src={img2} fill className="object-cover" alt="img" />
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className="w-[100%] h-screen relative">
          <Image src={img3} fill className="object-cover" alt="img" />
        </div>
      </SwiperSlide>
    </Swiper>
  ) : (
